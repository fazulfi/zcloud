export default {
  dashboard: {
    ...
    buyModelTokens: 'Buy model tokens',
    pickPlanUnlockModel: 'Pick a plan to unlock a model',
    modelCatalog: 'Model catalog',
    compareModelPricing: 'Compare models and pricing',
    catalog: {
      eyebrow: 'Model Catalog',
      title: 'Your models, your tokens',
      description: 'Every plan unlocks one model with its own token balance. Tokens never expire and stack across purchases.',
