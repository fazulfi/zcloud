        ...
        <template v-else>
          ...
          <template v-if="activeTab === 'recharge'">
            ...
            <div class="card p-5">
              ...
              <p v-if="!checkout.balance_disabled" class="mt-0.5 text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('common.accountCredit') }}: ${{ user?.balance?.toFixed(2) || '0.00' }}</p>
            </div>
