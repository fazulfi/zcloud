...
// The QrisPaymentFunc type is an adapter to allow the use of ordinary function as a Querier.
type QrisPaymentFunc func(context.Context, *ent.QrisPaymentQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f QrisPaymentFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.QrisPaymentQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.QrisPaymentQuery", q)
}

// The TraverseQrisPayment type is an adapter to allow the use of ordinary function as Traverser.
type TraverseQrisPayment func(context.Context, *ent.QrisPaymentQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseQrisPayment) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseQrisPayment) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.QrisPaymentQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.QrisPaymentQuery", q)
}
...
// The SupplierPricingFunc type is an adapter to allow the use of ordinary function as a Querier.
type SupplierPricingFunc func(context.Context, *ent.SupplierPricingQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SupplierPricingFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SupplierPricingQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SupplierPricingQuery", q)
}

// The TraverseSupplierPricing type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSupplierPricing func(context.Context, *ent.SupplierPricingQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSupplierPricing) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSupplierPricing) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SupplierPricingQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SupplierPricingQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.QrisPaymentQuery:
		return &query[*ent.QrisPaymentQuery, predicate.QrisPayment, qrispayment.OrderOption]{typ: ent.TypeQrisPayment, tq: q}, nil
	...
	case *ent.SupplierPricingQuery:
		return &query[*ent.SupplierPricingQuery, predicate.SupplierPricing, supplierpricing.OrderOption]{typ: ent.TypeSupplierPricing, tq: q}, nil
