...
func PaymentMethod(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldPaymentMethod, v))
}

// QrisPaymentID applies equality check predicate on the "qris_payment_id" field. It's identical to QrisPaymentIDEQ.
func QrisPaymentID(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisPaymentID, v))
}

// QrisPaymentRef applies equality check predicate on the "qris_payment_ref" field. It's identical to QrisPaymentRefEQ.
func QrisPaymentRef(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisPaymentRef, v))
}

// QrisExpiresAt applies equality check predicate on the "qris_expires_at" field. It's identical to QrisExpiresAtEQ.
func QrisExpiresAt(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisExpiresAt, v))
}

// QrisStatus applies equality check predicate on the "qris_status" field. It's identical to QrisStatusEQ.
func QrisStatus(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisStatus, v))
}

// PlanIDUUID applies equality check predicate on the "plan_id_uuid" field. It's identical to PlanIDUUIDEQ.
func PlanIDUUID(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldPlanIDUUID, v))
}

// AmountIdr applies equality check predicate on the "amount_idr" field. It's identical to AmountIdrEQ.
func AmountIdr(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldAmountIdr, v))
}
...
func Asset(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldAsset, v))
}

// Network applies equality check predicate on the "network" field. It's identical to NetworkEQ.
func Network(v string) predicate.PaymentOrder {
...
func PaymentMethodEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldPaymentMethod, v))
}

// PaymentMethodNEQ applies the NEQ predicate on the "payment_method" field.
func PaymentMethodNEQ(v string) predicate.PaymentOrder {
...
func PaymentMethodIn(vs ...string) predicate.PaymentOrder {
...
func PaymentMethodNotIn(vs ...string) predicate.PaymentOrder {
...
func PaymentMethodGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldPaymentMethod, v))
}

// PaymentMethodGTE applies the GTE predicate on the "payment_method" field.
func PaymentMethodGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldPaymentMethod, v))
}

// PaymentMethodLT applies the LT predicate on the "payment_method" field.
func PaymentMethodLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldPaymentMethod, v))
}

// PaymentMethodLTE applies the LTE predicate on the "payment_method" field.
func PaymentMethodLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldPaymentMethod, v))
}

// PaymentMethodContains applies the Contains predicate on the "payment_method" field.
func PaymentMethodContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldPaymentMethod, v))
}

// PaymentMethodHasPrefix applies the HasPrefix predicate on the "payment_method" field.
func PaymentMethodHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldPaymentMethod, v))
}

// PaymentMethodHasSuffix applies the HasSuffix predicate on the "payment_method" field.
func PaymentMethodHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldPaymentMethod, v))
}

// PaymentMethodEqualFold applies the EqualFold predicate on the "payment_method" field.
func PaymentMethodEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldPaymentMethod, v))
}

// PaymentMethodContainsFold applies the ContainsFold predicate on the "payment_method" field.
func PaymentMethodContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldPaymentMethod, v))
}

// QrisPaymentIDEQ applies the EQ predicate on the "qris_payment_id" field.
func QrisPaymentIDEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisPaymentID, v))
}

// QrisPaymentIDNEQ applies the NEQ predicate on the "qris_payment_id" field.
func QrisPaymentIDNEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldQrisPaymentID, v))
}

// QrisPaymentIDIn applies the In predicate on the "qris_payment_id" field.
func QrisPaymentIDIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldQrisPaymentID, vs...))
}

// QrisPaymentIDNotIn applies the NotIn predicate on the "qris_payment_id" field.
func QrisPaymentIDNotIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldQrisPaymentID, vs...))
}

// QrisPaymentIDGT applies the GT predicate on the "qris_payment_id" field.
func QrisPaymentIDGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldQrisPaymentID, v))
}

// QrisPaymentIDGTE applies the GTE predicate on the "qris_payment_id" field.
func QrisPaymentIDGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldQrisPaymentID, v))
}

// QrisPaymentIDLT applies the LT predicate on the "qris_payment_id" field.
func QrisPaymentIDLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldQrisPaymentID, v))
}

// QrisPaymentIDLTE applies the LTE predicate on the "qris_payment_id" field.
func QrisPaymentIDLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldQrisPaymentID, v))
}

// QrisPaymentIDContains applies the Contains predicate on the "qris_payment_id" field.
func QrisPaymentIDContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldQrisPaymentID, v))
}

// QrisPaymentIDHasPrefix applies the HasPrefix predicate on the "qris_payment_id" field.
func QrisPaymentIDHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldQrisPaymentID, v))
}

// QrisPaymentIDHasSuffix applies the HasSuffix predicate on the "qris_payment_id" field.
func QrisPaymentIDHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldQrisPaymentID, v))
}

// QrisPaymentIDIsNil applies the IsNil predicate on the "qris_payment_id" field.
func QrisPaymentIDIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldQrisPaymentID))
}

// QrisPaymentIDNotNil applies the NotNil predicate on the "qris_payment_id" field.
func QrisPaymentIDNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldQrisPaymentID))
}

// QrisPaymentIDEqualFold applies the EqualFold predicate on the "qris_payment_id" field.
func QrisPaymentIDEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldQrisPaymentID, v))
}

// QrisPaymentIDContainsFold applies the ContainsFold predicate on the "qris_payment_id" field.
func QrisPaymentIDContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldQrisPaymentID, v))
}

// QrisPaymentRefEQ applies the EQ predicate on the "qris_payment_ref" field.
func QrisPaymentRefEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisPaymentRef, v))
}

// QrisPaymentRefNEQ applies the NEQ predicate on the "qris_payment_ref" field.
func QrisPaymentRefNEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldQrisPaymentRef, v))
}

// QrisPaymentRefIn applies the In predicate on the "qris_payment_ref" field.
func QrisPaymentRefIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldQrisPaymentRef, vs...))
}

// QrisPaymentRefNotIn applies the NotIn predicate on the "qris_payment_ref" field.
func QrisPaymentRefNotIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldQrisPaymentRef, vs...))
}

// QrisPaymentRefGT applies the GT predicate on the "qris_payment_ref" field.
func QrisPaymentRefGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldQrisPaymentRef, v))
}

// QrisPaymentRefGTE applies the GTE predicate on the "qris_payment_ref" field.
func QrisPaymentRefGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldQrisPaymentRef, v))
}

// QrisPaymentRefLT applies the LT predicate on the "qris_payment_ref" field.
func QrisPaymentRefLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldQrisPaymentRef, v))
}

// QrisPaymentRefLTE applies the LTE predicate on the "qris_payment_ref" field.
func QrisPaymentRefLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldQrisPaymentRef, v))
}

// QrisPaymentRefContains applies the Contains predicate on the "qris_payment_ref" field.
func QrisPaymentRefContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldQrisPaymentRef, v))
}

// QrisPaymentRefHasPrefix applies the HasPrefix predicate on the "qris_payment_ref" field.
func QrisPaymentRefHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldQrisPaymentRef, v))
}

// QrisPaymentRefHasSuffix applies the HasSuffix predicate on the "qris_payment_ref" field.
func QrisPaymentRefHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldQrisPaymentRef, v))
}

// QrisPaymentRefIsNil applies the IsNil predicate on the "qris_payment_ref" field.
func QrisPaymentRefIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldQrisPaymentRef))
}

// QrisPaymentRefNotNil applies the NotNil predicate on the "qris_payment_ref" field.
func QrisPaymentRefNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldQrisPaymentRef))
}

// QrisPaymentRefEqualFold applies the EqualFold predicate on the "qris_payment_ref" field.
func QrisPaymentRefEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldQrisPaymentRef, v))
}

// QrisPaymentRefContainsFold applies the ContainsFold predicate on the "qris_payment_ref" field.
func QrisPaymentRefContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldQrisPaymentRef, v))
}

// QrisExpiresAtEQ applies the EQ predicate on the "qris_expires_at" field.
func QrisExpiresAtEQ(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisExpiresAt, v))
}

// QrisExpiresAtNEQ applies the NEQ predicate on the "qris_expires_at" field.
func QrisExpiresAtNEQ(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldQrisExpiresAt, v))
}

// QrisExpiresAtIn applies the In predicate on the "qris_expires_at" field.
func QrisExpiresAtIn(vs ...time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldQrisExpiresAt, vs...))
}

// QrisExpiresAtNotIn applies the NotIn predicate on the "qris_expires_at" field.
func QrisExpiresAtNotIn(vs ...time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldQrisExpiresAt, vs...))
}

// QrisExpiresAtGT applies the GT predicate on the "qris_expires_at" field.
func QrisExpiresAtGT(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldQrisExpiresAt, v))
}

// QrisExpiresAtGTE applies the GTE predicate on the "qris_expires_at" field.
func QrisExpiresAtGTE(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldQrisExpiresAt, v))
}

// QrisExpiresAtLT applies the LT predicate on the "qris_expires_at" field.
func QrisExpiresAtLT(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldQrisExpiresAt, v))
}

// QrisExpiresAtLTE applies the LTE predicate on the "qris_expires_at" field.
func QrisExpiresAtLTE(v time.Time) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldQrisExpiresAt, v))
}

// QrisExpiresAtIsNil applies the IsNil predicate on the "qris_expires_at" field.
func QrisExpiresAtIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldQrisExpiresAt))
}

// QrisExpiresAtNotNil applies the NotNil predicate on the "qris_expires_at" field.
func QrisExpiresAtNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldQrisExpiresAt))
}

// QrisStatusEQ applies the EQ predicate on the "qris_status" field.
func QrisStatusEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldQrisStatus, v))
}

// QrisStatusNEQ applies the NEQ predicate on the "qris_status" field.
func QrisStatusNEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldQrisStatus, v))
}

// QrisStatusIn applies the In predicate on the "qris_status" field.
func QrisStatusIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldQrisStatus, vs...))
}

// QrisStatusNotIn applies the NotIn predicate on the "qris_status" field.
func QrisStatusNotIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldQrisStatus, vs...))
}

// QrisStatusGT applies the GT predicate on the "qris_status" field.
func QrisStatusGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldQrisStatus, v))
}

// QrisStatusGTE applies the GTE predicate on the "qris_status" field.
func QrisStatusGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldQrisStatus, v))
}

// QrisStatusLT applies the LT predicate on the "qris_status" field.
func QrisStatusLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldQrisStatus, v))
}

// QrisStatusLTE applies the LTE predicate on the "qris_status" field.
func QrisStatusLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldQrisStatus, v))
}

// QrisStatusContains applies the Contains predicate on the "qris_status" field.
func QrisStatusContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldQrisStatus, v))
}

// QrisStatusHasPrefix applies the HasPrefix predicate on the "qris_status" field.
func QrisStatusHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldQrisStatus, v))
}

// QrisStatusHasSuffix applies the HasSuffix predicate on the "qris_status" field.
func QrisStatusHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldQrisStatus, v))
}

// QrisStatusEqualFold applies the EqualFold predicate on the "qris_status" field.
func QrisStatusEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldQrisStatus, v))
}

// QrisStatusContainsFold applies the ContainsFold predicate on the "qris_status" field.
func QrisStatusContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldQrisStatus, v))
}

// PlanIDUUIDEQ applies the EQ predicate on the "plan_id_uuid" field.
func PlanIDUUIDEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldPlanIDUUID, v))
}

// PlanIDUUIDNEQ applies the NEQ predicate on the "plan_id_uuid" field.
func PlanIDUUIDNEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldPlanIDUUID, v))
}

// PlanIDUUIDIn applies the In predicate on the "plan_id_uuid" field.
func PlanIDUUIDIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldPlanIDUUID, vs...))
}

// PlanIDUUIDNotIn applies the NotIn predicate on the "plan_id_uuid" field.
func PlanIDUUIDNotIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldPlanIDUUID, vs...))
}

// PlanIDUUIDGT applies the GT predicate on the "plan_id_uuid" field.
func PlanIDUUIDGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldPlanIDUUID, v))
}

// PlanIDUUIDGTE applies the GTE predicate on the "plan_id_uuid" field.
func PlanIDUUIDGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldPlanIDUUID, v))
}

// PlanIDUUIDLT applies the LT predicate on the "plan_id_uuid" field.
func PlanIDUUIDLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldPlanIDUUID, v))
}

// PlanIDUUIDLTE applies the LTE predicate on the "plan_id_uuid" field.
func PlanIDUUIDLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldPlanIDUUID, v))
}

// PlanIDUUIDContains applies the Contains predicate on the "plan_id_uuid" field.
func PlanIDUUIDContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldPlanIDUUID, v))
}

// PlanIDUUIDHasPrefix applies the HasPrefix predicate on the "plan_id_uuid" field.
func PlanIDUUIDHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldPlanIDUUID, v))
}

// PlanIDUUIDHasSuffix applies the HasSuffix predicate on the "plan_id_uuid" field.
func PlanIDUUIDHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldPlanIDUUID, v))
}

// PlanIDUUIDIsNil applies the IsNil predicate on the "plan_id_uuid" field.
func PlanIDUUIDIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldPlanIDUUID))
}

// PlanIDUUIDNotNil applies the NotNil predicate on the "plan_id_uuid" field.
func PlanIDUUIDNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldPlanIDUUID))
}

// PlanIDUUIDEqualFold applies the EqualFold predicate on the "plan_id_uuid" field.
func PlanIDUUIDEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldPlanIDUUID, v))
}

// PlanIDUUIDContainsFold applies the ContainsFold predicate on the "plan_id_uuid" field.
func PlanIDUUIDContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldPlanIDUUID, v))
}

// AmountIdrEQ applies the EQ predicate on the "amount_idr" field.
func AmountIdrEQ(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldAmountIdr, v))
}

// AmountIdrNEQ applies the NEQ predicate on the "amount_idr" field.
func AmountIdrNEQ(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldAmountIdr, v))
}

// AmountIdrIn applies the In predicate on the "amount_idr" field.
func AmountIdrIn(vs ...int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldAmountIdr, vs...))
}

// AmountIdrNotIn applies the NotIn predicate on the "amount_idr" field.
func AmountIdrNotIn(vs ...int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldAmountIdr, vs...))
}

// AmountIdrGT applies the GT predicate on the "amount_idr" field.
func AmountIdrGT(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldAmountIdr, v))
}

// AmountIdrGTE applies the GTE predicate on the "amount_idr" field.
func AmountIdrGTE(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldAmountIdr, v))
}

// AmountIdrLT applies the LT predicate on the "amount_idr" field.
func AmountIdrLT(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldAmountIdr, v))
}

// AmountIdrLTE applies the LTE predicate on the "amount_idr" field.
func AmountIdrLTE(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldAmountIdr, v))
}

// AmountIdrIsNil applies the IsNil predicate on the "amount_idr" field.
func AmountIdrIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldAmountIdr))
}

// AmountIdrNotNil applies the NotNil predicate on the "amount_idr" field.
func AmountIdrNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldAmountIdr))
}
...
func AssetEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldAsset, v))
}

// AssetNEQ applies the NEQ predicate on the "asset" field.
func AssetNEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldAsset, v))
}

// AssetIn applies the In predicate on the "asset" field.
func AssetIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldAsset, vs...))
}

// AssetNotIn applies the NotIn predicate on the "asset" field.
func AssetNotIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldAsset, vs...))
}

// AssetGT applies the GT predicate on the "asset" field.
func AssetGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldAsset, v))
}

// AssetGTE applies the GTE predicate on the "asset" field.
func AssetGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldAsset, v))
}

// AssetLT applies the LT predicate on the "asset" field.
func AssetLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldAsset, v))
}

// AssetLTE applies the LTE predicate on the "asset" field.
func AssetLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldAsset, v))
}

// AssetContains applies the Contains predicate on the "asset" field.
func AssetContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldAsset, v))
}

// AssetHasPrefix applies the HasPrefix predicate on the "asset" field.
func AssetHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldAsset, v))
}

// AssetHasSuffix applies the HasSuffix predicate on the "asset" field.
func AssetHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldAsset, v))
}

// AssetEqualFold applies the EqualFold predicate on the "asset" field.
func AssetEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldAsset, v))
}

// AssetContainsFold applies the ContainsFold predicate on the "asset" field.
func AssetContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldAsset, v))
}

// NetworkEQ applies the EQ predicate on the "network" field.
func NetworkEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldNetwork, v))
}

// NetworkNEQ applies the NEQ predicate on the "network" field.
func NetworkNEQ(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNEQ(FieldNetwork, v))
}

// NetworkIn applies the In predicate on the "network" field.
func NetworkIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIn(FieldNetwork, vs...))
}

// NetworkNotIn applies the NotIn predicate on the "network" field.
func NetworkNotIn(vs ...string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotIn(FieldNetwork, vs...))
}

// NetworkGT applies the GT predicate on the "network" field.
func NetworkGT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGT(FieldNetwork, v))
}

// NetworkGTE applies the GTE predicate on the "network" field.
func NetworkGTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldGTE(FieldNetwork, v))
}

// NetworkLT applies the LT predicate on the "network" field.
func NetworkLT(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLT(FieldNetwork, v))
}

// NetworkLTE applies the LTE predicate on the "network" field.
func NetworkLTE(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldLTE(FieldNetwork, v))
}

// NetworkContains applies the Contains predicate on the "network" field.
func NetworkContains(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContains(FieldNetwork, v))
}

// NetworkHasPrefix applies the HasPrefix predicate on the "network" field.
func NetworkHasPrefix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasPrefix(FieldNetwork, v))
}

// NetworkHasSuffix applies the HasSuffix predicate on the "network" field.
func NetworkHasSuffix(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldHasSuffix(FieldNetwork, v))
}

// NetworkEqualFold applies the EqualFold predicate on the "network" field.
func NetworkEqualFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEqualFold(FieldNetwork, v))
}

// NetworkContainsFold applies the ContainsFold predicate on the "network" field.
func NetworkContainsFold(v string) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldContainsFold(FieldNetwork, v))
}
