...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			apikeymodelscope.Table:              apikeymodelscope.ValidColumn,
			...
			modelbalance.Table:                  modelbalance.ValidColumn,
			...
			qrispayment.Table:                   qrispayment.ValidColumn,
			redeemcode.Table:                    redeemcode.ValidColumn,
			securitysecret.Table:                securitysecret.ValidColumn,
			setting.Table:                       setting.ValidColumn,
			subscriptionplan.Table:              subscriptionplan.ValidColumn,
			supplierpricing.Table:               supplierpricing.ValidColumn,
			tlsfingerprintprofile.Table:         tlsfingerprintprofile.ValidColumn,
			usagecleanuptask.Table:              usagecleanuptask.ValidColumn,
			usagelog.Table:                      usagelog.ValidColumn,
			usagemodelsnapshot.Table:            usagemodelsnapshot.ValidColumn,
