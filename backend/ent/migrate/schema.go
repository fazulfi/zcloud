...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "display_input_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "display_output_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "display_cache_read_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "display_cache_write_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "display_total_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "display_blend_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "cost_input", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "cost_output", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "cost_cache_read", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "cost_cache_write", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "cost_total", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "cost_supplier_code", Type: field.TypeString, Size: 20, Default: ""},
		{Name: "pricing_version", Type: field.TypeInt, Default: 0},
		{Name: "reservation_status", Type: field.TypeString, Size: 16, Default: "finalized"},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	// UsageModelSnapshotsColumns holds the columns for the "usage_model_snapshots" table.
	UsageModelSnapshotsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		...
		{Name: "usage_model_pct", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "numeric(10,6)"}},
	}
	// UsageModelSnapshotsTable holds the schema information for the "usage_model_snapshots" table.
	UsageModelSnapshotsTable = &schema.Table{
		Name:       "usage_model_snapshots",
		Columns:    UsageModelSnapshotsColumns,
		PrimaryKey: []*schema.Column{UsageModelSnapshotsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "usagemodelsnapshot_user_id_model_pricing_version",
				Unique:  true,
				Columns: []*schema.Column{UsageModelSnapshotsColumns[3], UsageModelSnapshotsColumns[4], UsageModelSnapshotsColumns[5]},
			},
		},
	}
